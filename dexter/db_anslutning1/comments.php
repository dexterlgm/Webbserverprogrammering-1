...
if(isset($_POST['sumbit'])){
    ...
    $sql = "INSERT INTO tblusers VALUES ('$firstname', '$lastname', '$comment', NULL)";
...
foreach($query as $usercomment){
    ...
    echo    "<h4 class=comments><section>
                <header class=namn>$firstname $lastname:</header>
                <h5>$comment<h5>
            </section></h4>";
}

$sql = "SELECT * FROM tblusers ORDER BY  commentid DESC";
